    ...
    <article class="col-lg-8 col-sm-12 p-0">
        ...
        <main class="d-flex flex-column ">
            ...
            <header class="article-header d-flex flex-column  ">
                ...
                <!-- feature image -->
                <img class="img-fluid rounded-3 mt-2 "
                    src="<?php echo get_the_post_thumbnail_url(get_the_ID(),'medium'); ?>" alt="<?php echo get_the_title(); 
                ?>">
            ...
            <section class="article-body d-flex flex-column-reverse flex-md-row ">
                ...
                <div class="col-lg-11">
                    ...
                    <!-- article accesability bar -->
                     <div class="article-accesabilty-nav mt-4 mb-2 mt-md-4 mb-md-5 d-flex justify-content-between p-1">
                    <!-- font size toggle -->
                     <div class="article-accesabilty-nav__toggle d-flex justify-content-center align-content-center">
                        ...
                        <button id="textSizeToggle" onclick="toggleTextSize()" class="d-flex border-0 bg__red rounded-1 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-type" viewBox="0 0 16 16">
                    ...
                    <div class="article-accesabilty-nav__toggle d-flex justify-content-center align-content-center">
                        ...
                        <button id="darkModeToggle" onclick="toggleDarkMode()" class="d-flex border-0 bg__red rounded-1 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-heptagon-half" viewBox="0 0 16 16">
